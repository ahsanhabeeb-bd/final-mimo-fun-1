...
public class HomeActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
       ...
       // slideModels.add(new SlideModel(R.drawable.slide5,ScaleTypes.FIT));
        ...
        FirebaseDatabase.getInstance().getReference().child("slyder").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot data:snapshot.getChildren())
                    slideModels.add(new SlideModel(data.child("url").getValue().toString(),ScaleTypes.FIT));
                   // slideModels1.add(new SlideModel(data.child("url").getValue().toString(),ScaleTypes.FIT));
                    ...
                    slider.setItemClickListener(new ItemClickListener() {
                        ...
                        public void onItemSelected(int i) {
                           ...
                           // Toast.makeText(getApplicationContext(),slideModels.get(i).getTitle().toString(),Toast.LENGTH_SHORT).show();
                           // Toast.makeText(getApplicationContext(), "okok", Toast.LENGTH_SHORT).show();
                            Toast.makeText(getApplicationContext(),slideModels.get(i).getImageUrl().toString(),Toast.LENGTH_SHORT).show();
                        }
                    });
            }
