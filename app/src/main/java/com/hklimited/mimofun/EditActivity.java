...
public class EditActivity extends AppCompatActivity
{
    ...
    private ImageView name_color_but;

    private Button save_data;
    private int defolecolor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name_color_but= (ImageView) findViewById(R.id.name_color_but) ;

     //   int age = Integer.parseInt(edit_age.getText().toString());


        defolecolor= ContextCompat.getColor(EditActivity.this,R.color.black);

       // databaseReference.child("name_color").setValue(defolecolor);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                name2.setTextColor(Integer.parseInt(name_color));
        ...
        name_color_but.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                AmbilWarnaDialog coloepicker = new AmbilWarnaDialog(EditActivity.this, defolecolor, new AmbilWarnaDialog.OnAmbilWarnaListener() {
                    @Override
